...
class PDFDocument extends JavaObject {
  ...
  static loadSync(path, isUrl = false) {
    const PDFDocumentJava = java.import('br.com.appmania.PDFDocument');
    return new PDFDocument(PDFDocumentJava.loadSync(path, isUrl));
  }

  /* asynchronous operations */

  static load(path, isUrl = false) {
    return when.promise(function(resolve, reject) {
      const PDFDocumentJava = java.import('br.com.appmania.PDFDocument');
      PDFDocumentJava.loadPromise(path, isUrl)
      .then(function(doc) {
